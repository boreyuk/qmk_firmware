...
enum led_location_map {
    LED_ESC,    // 0, ESC, k13
    LED_GRV,    // 1, ~, k16, reassigned to <> (ISO key)
    LED_TAB,    // 2, Tab, k11
    LED_CAPS,   // 3, Caps, k21
    LED_LSFT,   // 4, Sh_L, k00
    LED_LCTL,   // 5, Ct_L, k06
    ...
    LED_L2,     // 70, LED, l02
    LED_R2,     // 71, LED, l12
    LED_PGUP,    // 72, Del, k65, remapped to PgUp
    LED_L3,     // 73, LED, l03
    LED_R3,     // 74, LED, l13
    LED_PGDN,   // 75, PgUp, k15, remapped to PgDn
    LED_L4,     // 76, LED, l04
    LED_R4,     // 77, LED, l14
    LED_EQL,    // 78, =, k66
    ...
    LED_L5,     // 80, LED, l05
    LED_R5,     // 81, LED, l15
    LED_MPLY,    // 82, End, k75, remapped to media play
    LED_L6,     // 83, LED, l06
    LED_R6,     // 84, LED, l16
    LED_BSPC,   // 85, BSpc, ka1
    LED_DEL,    // 86, PgDn, k25, remapped to Del
    LED_L7,     // 87, LED, l07
    LED_R7,     // 88, LED, l17
    LED_RBRC,   // 89, ], k61
